...
# SET VARIABLES
SUBJ_DIR=/{{ home_mount }}/{{ main_user }}/data/UCSD/${1}
TEMPLATE_DIR=/{{ home_mount }}/{{ main_user }}/SingleExposure/templates

# REORIENT
#/{{ home_mount }}/{{ main_user }}/apps/mricron/dcm2nii -r y -g n -o ${SUBJ_DIR}/T1_brain.nii

# ACPC ALIGN
/{{ home_mount }}/{{ main_user }}/apps/art/acpcdetect -M \ 
-i ${SUBJ_DIR}/T1_brain.nii \
-o ${SUBJ_DIR}/acpc.nii \
#rm ${SUBJ_DIR}/T1_brain.nii

# RESAMPLE TO 1 ISOTROPIC
/{{ home_mount }}/{{ main_user }}/apps/c3d-1.0.0-Linux-x86_64/bin/c3d -verbose \
${SUBJ_DIR}/acpc.nii \
-resample-mm 1x1x1mm \
...
/{{ home_mount }}/{{ main_user }}/apps/ants-20160404/bin/N4BiasFieldCorrection -d 3 -v 1 \
...
#/{{ home_mount }}/{{ main_user }}/apps/ants-20160404/bin/antsCorticalThickness.sh -d 3 -k 0 \
