...
Afterwards, use squeue to see if all the subjects are processed. When they're all done you can run after_shape.sh to create csv files from the shape output.
